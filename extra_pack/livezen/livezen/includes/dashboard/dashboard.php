...
function kaswara_dashboard_menu(){
    ...
    //Add Submenu Page For The Icon Manager
    add_submenu_page(
        'kaswara-framework',
        esc_html__('Icon Manager','kaswara'),
        esc_html__('Icon Manager','kaswara'),
        'manage_options',
        'kaswara-icon-manager',
        'kaswara_icon_manager_render'
    );
}
...
function kaswara_icon_manager_render(){
    ?>  
        <?php kaswara_dashboard_maker('icon-manager'); ?>                      
        <div class="kswr-dash-content" style="background: #23282d; padding: 0px;">      
            <?php include_once(KASWARA_PLUGIN_PATH.'includes/dashboard/sections/icon-manager.php'); ?>
        </div>   
    <?php 
}
