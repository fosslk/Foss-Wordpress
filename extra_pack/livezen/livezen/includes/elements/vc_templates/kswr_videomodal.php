...
function kswr_videomodal_shortC($atts,$content){  
	...
	if($modalv_trigger_type == 'image'){		
	 	$trigger = '<div class="km-modal-video-tgr-container" data-position="'.$modalv_tgr_imagealign.'"><div onclick="kswr_show_modalwindow(this);"  class="km-trigger km-modal-video-tgr"  data-modal="'.$modal_id.'" style="'.$trigger_style.'"><img src="'.esc_url($img_src[0]).'"/></div></div>';
	}
