...
function kswr_iconboxinfo_shortC($atts, $content) {  
	...
	$iconArea = kaswara_icon_element_output($iconSettings);
 	...
 	$outPut .= '<div class="kswr-ibi-title-ct"><div class="kswr-ibi-title kswr-shortcode-element" data-fontsettings="'.esc_attr($ibi_title_fsize).'" style="'.$titleStyle.'">'.$ibi_title.'</div><div class="kswr-ibi-subtitle kswr-shortcode-element" data-fontsettings="'.esc_attr($ibi_subtitle_fsize).'" style="'.$subTitleStyle.'">'.$ibi_subtitle.'</div></div><div class="kswr-ibi-bottom"><div class="kswr-ibi-content kswr-shortcode-element" data-fontsettings="'.esc_attr($ibi_content_fsize).'" style="'.$contentStyle.'">'.do_shortcode($content).'</div></div>';
