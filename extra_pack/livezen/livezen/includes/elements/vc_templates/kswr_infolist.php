	...
	class Kaswara_iconinfoboxlist
	{
		...
		function kaswara_infoboxitem_child_shortcode($atts,$content = null){				
			...
			$iibl_bgsize = kswr_shortcode_attribute_value('iibl_bgsize',$iibl_style_default, $iibl_bgsize,'infolist');
		 	...
		 	$outPut .= '<div class="kswr-iibl-title-ct"><div class="kswr-iibl-title kswr-shortcode-element" data-fontsettings="'.esc_attr($iibl_title_fsize).'" style="'.$titleStyle.'">'.$iibl_title.'</div><div class="kswr-iibl-subtitle kswr-shortcode-element" data-fontsettings="'.esc_attr($iibl_subtitle_fsize).'" style="'.$subTitleStyle.'">'.$iibl_subtitle.'</div></div><div class="kswr-iibl-bottom"><div class="kswr-iibl-content kswr-shortcode-element" data-fontsettings="'.esc_attr($iibl_content_fsize).'" style="'.$contentStyle.'">'.do_shortcode($content).'</div></div>';
