...
function kswr_heading_shortC($atts,$content) {  
	...
	kswr_load_the_font_front($head_subtitle_fstyle);
 	...
 	$outPut = '<div class="kswr-heading-container kswr-theelement" style="text-align:'.$head_align.';">
				<div class="kswr-heading-title kswr-shortcode-element" data-fontsettings="'.esc_attr($head_title_fsize).'" style="'.$titleStyling.'">'.$head_title.'</div>
				<div class="kswr-heading-content kswr-shortcode-element" data-fontsettings="'.esc_attr($head_subtitle_fsize).'" style="'.$subTitleStyling.'">'.do_shortcode($content).'</div>
			</div>';
 	return $outPut;
 }
