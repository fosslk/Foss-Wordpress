...
function kswr_fancytext_shortC($atts) {  
	...
	kswr_load_the_font_front($fctxt_content_fstyle);
 	...
 	$outPut = '<div class="kswr-fancytext-container kswr-theelement" style="'.$containerStyle.'">
					<span class="kswr-fancytext-prefix kswr-shortcode-element" data-fontsettings="'.esc_attr($fctxt_prefix_fsize).'" style="'.$prefixStyle.'">'.$fctxt_prefix.'</span> 
					<span class="kswr-fancytext kswr-shortcode-element" data-fontsettings="'.esc_attr($fctxt_content_fsize).'" style="'.$contentStyle.'" data-style="'.esc_attr($fctxt_style).'" data-holdtime="'.esc_attr($fctxt_holdtime).'" data-cursor="'.esc_attr($fctxt_cursor).'" data-typespeed="'.esc_attr($fctxt_typespeed).'" data-typeanimation="'.esc_attr($fctxt_typeanimation).'" data-words="'.esc_attr($wordsArray).'"></span>
					<span class="kswr-fancytext-suffix kswr-shortcode-element" data-fontsettings="'.esc_attr($fctxt_suffix_fsize).'" style="'.$suffixStyle.'">'.$fctxt_suffix.'</span> 
				</div>';
