...
function kswr_testmonial_shortC($atts,$content) {  
	...
	$picture = '';
	if($picture_enable == '1')
		$picture = '<div class="km-testimonial-pic" style="'.$picturePaddings .'">'.$pictureBorder.'<img src="'.esc_url($img_src[0]).'"></div>';		
  	
  	$info = '<div class="km-testimonial-name-info" style="'.$infoPaddings.'" >'.$infoBorder.'<span class="km-testimonial-name kswr-shortcode-element" data-fontsettings="'.esc_attr($test_name_fsize).'" '.$name_style.'>'.$name.'</span><span class="km-testimonial-info kswr-shortcode-element" data-fontsettings="'.esc_attr($test_title_fsize).'" '.$title_style.'>'.$title.'</span></div>';
	...
	$outPut .= '<div class="km-testimonial" data-style="'.esc_attr($style).'" data-pic-position="'.esc_attr($position).'" style="background:'.$bg.'; '.$testi_container_margin.'"  '.$child_data.'>
					<div class="km-testimonial-content kswr-shortcode-element" data-fontsettings="'.esc_attr($test_content_fsize).'" '.$content_style.' >';
