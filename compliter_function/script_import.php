...
class Bootstrap_walker extends Walker_Nav_Menu{
  ...
  function start_lvl(&$output, $depth = 0, $args = Array()) {
    ...
    $output .= "\n$indent<ul class=\"dropdown-menu\"><div class=\"\">\n";
  }
...
if( !function_exists("wp_bootstrap_theme_styles") ) {  
    function wp_bootstrap_theme_styles() { 
        ...
        wp_register_style( 'rock', get_template_directory_uri() . '/library/dist/css/nav.css', array(), '1.0', 'all' );
        wp_enqueue_style( 'rock' );

        wp_register_style( 'autoscroll', get_template_directory_uri() . '/library/dist/css/autoscroll.css', array(), '1.0', 'all' );
        wp_enqueue_style( 'autoscroll' );
    }
}
...
if( !function_exists( "wp_bootstrap_theme_js" ) ) {  
  function wp_bootstrap_theme_js(){
    ...
    wp_register_script( 'navshink', 
      get_template_directory_uri() . '/bower_components/bootstrap/dist/js/navshink.js', 
      array('jquery'), 
      '2.1' );
    ...
    wp_register_script( 'roadhide', 
      get_template_directory_uri() . '/compliter_function/library/sroll_hider.js', 
      array('jquery'), 
      '1.2' );
      
    wp_enqueue_script( 'bootstrap' );
    wp_enqueue_script( 'roadhide' );
