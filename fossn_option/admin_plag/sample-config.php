<?php
    ...
    $args = array(
        ...
        'menu_title'           => __( 'FOSS Theme', 'redux-framework-demo' ),
        'page_title'           => __( 'FOSS Theme', 'redux-framework-demo' ),
    ...
    $args['share_icons'][] = array(
        'url'   => 'https://github.com/sanjayaharshana/fossntheme',
        'title' => 'Visit us on GitHub',
        'icon'  => 'el el-github'
        //'img'   => '', // You can use icon OR img. IMG needs to be a full URL.
    );
    $args['share_icons'][] = array(
        'url'   => 'https://www.facebook.com/fossnlk/',
        'title' => 'Like us on Facebook',
        'icon'  => 'el el-facebook'
    );
    $args['share_icons'][] = array(
        'url'   => 'http://twitter.com/sanjayaharshana',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'text-example',
                'type'     => 'text',
                'title'    => __( 'Web Title', 'redux-framework-demo' ),
                'subtitle' => __( 'Your website brand title', 'redux-framework-demo' ),
            ...
            array(
                ...
                'subtitle' => __( 'Upload any logo using LiveZen Admin Panel', 'redux-framework-demo' ),
            ...
            array(
                'id'          => 'text-placeholder',
                'type'        => 'text',
                'title'       => __( 'Site Titles', 'redux-framework-demo' ),
